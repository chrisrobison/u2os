...
| Personal initialization | Durable owner-to-entity link (#182); clean personal startup and persistent isolated demo mode (#185); connector mock fail-closed in personal mode (#186) | Rename/restart/legacy-link tests; fresh personal, explicit demo, unmarked legacy, disconnected-service, and cache-label fixtures | No | Review-based cleanup of ambiguous old fixtures (no automatic deletion); default model behavior still needs explicit personal-mode treatment |
