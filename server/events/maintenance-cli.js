import { checkEventLogIntegrity, pruneEvents, replayDerivedProjections } from './maintenance.js';
...
if (args.includes('--replay-projections')) result.replay = replayDerivedProjections({ apply: args.includes('--apply') });
