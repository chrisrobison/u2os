...
- Add calendar-conflict, birthday, renewal, important-message, and project-activity evaluators. (Calendar-conflict, birthday, and renewal evaluation are complete; important-message and project-activity remain pending.)
...
**Status: usable alpha reached.** Milestones 1–3 are complete, with 371 Node tests and 65 Playwright scenarios running across Chromium, Firefox, and WebKit.
