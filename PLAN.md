...
- Add calendar-conflict, birthday, renewal, important-message, and project-activity evaluators. (Calendar-conflict and renewal evaluation are complete; remaining evaluator types are still pending.)
...
**Status: usable alpha reached.** Milestones 1–3 are complete, with 370 Node tests and 65 Playwright scenarios running across Chromium, Firefox, and WebKit.
