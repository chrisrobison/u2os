...
- Add calendar-conflict, birthday, renewal, important-message, and project-activity evaluators. (Calendar-conflict, birthday, renewal, and important-message evaluation are complete; project-activity remains pending.)
...
**Status: usable alpha reached.** Milestones 1–3 are complete, with 372 Node tests and 65 Playwright scenarios running across Chromium, Firefox, and WebKit.
