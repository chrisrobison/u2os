...
| **Demo mocks** | The default planner remains deterministic; connector mocks run only in an explicit demo home. Personal mode reports unconfigured/disconnected services. |
