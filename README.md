...
| **Unavailable** | SMTP sending, CalDAV, Deepgram, ElevenLabs, cryptographic device pairing, external task-manager sync, native mobile/watch apps, and a U2OS-hosted cloud service |
